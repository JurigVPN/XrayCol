...
# // Exporting URL Host
export Server_URL="raw.githubusercontent.com/JurigVPN/test/master"
export Server1_URL="raw.githubusercontent.com/JurigVPN/limit/master"
...
wget -q -O /root/status "https://raw.githubusercontent.com/JurigVPN/XrayCol/main/statushariini"
...
echo -e "${CYAN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m${NC}"                                                                     
echo -e "${BICyan} ⇲  ${BICyan}Script Name     :  ${BIYellow}XrayJurig V $LocalVersion${NC}"    
...
echo -e "${BICyan} ⇲  ${BICyan}RAM             :  ${BIYellow}$RAM MB ${NC}"
echo -e "${BICyan} ⇲  ${BICyan}Usage MEMORY    :  ${BIYellow}$MEMOFREE${NC}" 
echo -e "${BICyan} ⇲  ${BICyan}Date            :  ${BIYellow}$DATEVPS${NC}"
echo -e "${BICyan} ⇲  ${BICyan}Time            :  ${BIYellow}$TIMEZONE${NC}"
...
echo -e "${CYAN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m${NC}"
echo -e " ${BICyan}  [${BIWhite}01${BICyan}]${RED} •${NC} ${CYAN}VMESS MENU      $NC  ${BICyan}[${BIWhite}11${BICyan}]${RED} • ${NC}${CYAN}BANNER CHANGE [OFF] $NC"
...
echo -e "${CYAN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m${NC}"
echo -e "${BICyan} ${BICyan}   Version      :  ${BIYellow}V $LocalVersion LTS${NC}"
echo -e "${BICyan} ${BICyan}   Clien Name   :  ${BIYellow}JurigVPN${NC}"
echo -e "${BICyan} ${BICyan}   Expired in   :  ${BIYellow}Lifetime${NC}"
echo -e "${CYAN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m${NC}"
rm -f /root/status
